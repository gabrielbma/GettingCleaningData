...
+ Last character of variable name - this is either an X, Y or Z, and represents the 3-dimensional axis that the respective measurement was taken along. The exception to this rule is the magnitude measurements, which are taken from the 3-dimensional vector representing the combination of X, Y and Z. These variables contain a "Mag" before the "Mean"/"STD"
